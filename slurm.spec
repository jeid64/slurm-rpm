...
Source: http://www.schedmd.com/download/latest/slurm-14.03.0.tar.bz2
...
rm -f $RPM_BUILD_ROOT/%{with_pam_dir}/pam_slurm.la
%endif
rm -f $RPM_BUILD_ROOT/%{_libdir}/security/pam_slurm.a
rm -f $RPM_BUILD_ROOT/%{_libdir}/security/pam_slurm.la
%if ! %{slurm_with auth_none}
